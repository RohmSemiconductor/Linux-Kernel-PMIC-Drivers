...
static const struct resource bd96811_reg_irqs[] = {
	DEFINE_RES_IRQ_NAMED(BD96811_CMD_SHDN_STAT, "cmd-shdn-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_GC_ERR_STAT, "gc-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT_BIST_ERR_STAT, "vout-bist-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_ABIST_ERR_STAT, "abist-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_DIN3_ERR_STAT, "din3-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_TW_ERR_STAT, "thermal-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_AD1_ERR_STAT, "ad1-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_AD2_ERR_STAT, "ad2-err"),

	DEFINE_RES_IRQ_NAMED(BD96811_VREF_ERR_STAT, "vref-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_TSD_ERR_STAT, "tsd"),
	DEFINE_RES_IRQ_NAMED(BD96811_UVLO_VIN_ERR_STAT, "uvlo-vin-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_OVLO_ERR_STAT, "ovlo-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_OSC_ERR_STAT, "osc-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_SLEEP_ERR_STAT, "sleep-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_UVLO_PVIN1_ERR_STAT, "uvlo-pvin1-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_PWR_CTRL_SEQ_ERR_STAT, "ctrl-seq-err"),

	/* Reg 0x55 VOUT1 ERR IRQs */
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_PVIN_ERR_STAT, "vout1-pvin-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_OVP_ERR_STAT, "vout1-ovp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_UVP_ERR_STAT, "vout1-uvp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_SHDN_ERR_STAT, "vout1-shdn-err"),

	/* Reg 0x56 VOUT2 ERR IRQs */
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_PVIN_ERR_STAT, "vout2-pvin-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_OVP_ERR_STAT, "vout2-ovp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_UVP_ERR_STAT, "vout2-uvp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_SHDN_ERR_STAT, "vout2-shdn-err"),

	/* Reg 0x57 VOUT3 ERR IRQs */
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_PVIN_ERR_STAT, "vout3-pvin-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_OVP_ERR_STAT, "vout3-ovp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_UVP_ERR_STAT, "vout3-uvp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_SHDN_ERR_STAT, "vout3-shdn-err"),

	/* Reg 0x58 VOUT4 ERR IRQs */
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_PVIN_ERR_STAT, "vout4-pvin-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_OVP_ERR_STAT, "vout4-ovp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_UVP_ERR_STAT, "vout4-uvp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_SHDN_ERR_STAT, "vout4-shdn-err"),

	/* Reg 0x59 LDO5 ERR IRQs */
	DEFINE_RES_IRQ_NAMED(BD96811_LDO5_UVLO_ERR_STAT, "ldo5-pvin-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_LDO5_OVP_ERR_STAT, "ldo5-ovp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_LDO5_UVP_ERR_STAT, "ldo5-uvp-err"),
	DEFINE_RES_IRQ_NAMED(BD96811_LDO5_SHDN_ERR_STAT, "ldo5-shdn-err"),

	DEFINE_RES_IRQ_NAMED(BD96811_TW_STAT, "core-thermal"),
	//DEFINE_RES_IRQ_NAMED(BD96811_WDT_ERR_STAT, ""),
	//DEFINE_RES_IRQ_NAMED(BD96811_I2C_ERR_STAT, ""),
	//DEFINE_RES_IRQ_NAMED(BD96811_TERR1_ERR_STAT, "terr1-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_TERR2_ERR_STAT, "terr2-err"),
	//DEFINE_RES_IRQ_NAMED(BD96811_DIN4_ERR_STAT, ""),

	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_HOCL_STAT, "vout1-overcurr-h"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_LOCL_STAT, "vout1-overcurr-l"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_NOCL_STAT, "vout1-overcurr-n"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_OVD_STAT, "vout1-ovd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_UVD_STAT, "vout1-uvd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT1_TW_CH_STAT, "vout1-tw"),

	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_HOCL_STAT, "vout2-overcurr-h"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_LOCL_STAT, "vout2-overcurr-l"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_NOCL_STAT, "vout2-overcurr-n"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_OVD_STAT, "vout2-ovd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_UVD_STAT, "vout2-uvd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT2_TW_CH_STAT, "vout2-tw"),

	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_HOCL_STAT, "vout3-overcurr-h"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_LOCL_STAT, "vout3-overcurr-l"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_NOCL_STAT, "vout3-overcurr-n"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_OVD_STAT, "vout3-ovd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_UVD_STAT, "vout3-uvd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT3_TW_CH_STAT, "vout3-tw"),

	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_HOCL_STAT, "vout4-overcurr-h"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_LOCL_STAT, "vout4-overcurr-l"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_NOCL_STAT, "vout4-overcurr-n"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_OVD_STAT, "vout4-ovd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_UVD_STAT, "vout4-uvd"),
	DEFINE_RES_IRQ_NAMED(BD96811_VOUT4_TW_CH_STAT, "vout4-tw"),

	DEFINE_RES_IRQ_NAMED(BD96811_LDO5_OVD_STAT, ""),
	DEFINE_RES_IRQ_NAMED(BD96811_LDO5_UVD_STAT, ""),
};
...
/* The BD96811 has different IRQ mapping than BD96801 and BD96802 */
static unsigned int bd96811_bit0_offsets[] = {0, 1, 7};	/* System stat, 3 registers */
static unsigned int bd96811_bit1_offsets[] = {2, 8};	/* VOUT1, 2 registers */
static unsigned int bd96811_bit2_offsets[] = {3, 9};	/* VOUT2, 2 registers */
static unsigned int bd96811_bit3_offsets[] = {4, 10};	/* VOUT3, 2 registers */
static unsigned int bd96811_bit4_offsets[] = {5, 11};	/* VOUT4, 2 registers */
static unsigned int bd96811_bit5_offsets[] = {6, 12};	/* LDO5, 2 registers */

static struct regmap_irq_sub_irq_map bd96811_sub_irq_offsets[] = {
	REGMAP_IRQ_MAIN_REG_OFFSET(bd96811_bit0_offsets),
	REGMAP_IRQ_MAIN_REG_OFFSET(bd96811_bit1_offsets),
	REGMAP_IRQ_MAIN_REG_OFFSET(bd96811_bit2_offsets),
	REGMAP_IRQ_MAIN_REG_OFFSET(bd96811_bit3_offsets),
	REGMAP_IRQ_MAIN_REG_OFFSET(bd96811_bit4_offsets),
	REGMAP_IRQ_MAIN_REG_OFFSET(bd96811_bit5_offsets),
};
...
static const struct regmap_irq bd96811_irqs[] = {
	REGMAP_IRQ_REG(BD96811_CMD_SHDN_STAT, 0, BD96811_CMD_SHDN_MASK),
	REGMAP_IRQ_REG(BD96811_GC_ERR_STAT, 0, BD96811_GC_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT_BIST_ERR_STAT, 0, BD96811_VOUT_BIST_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_ABIST_ERR_STAT, 0, BD96811_ABIST_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_DIN3_ERR_STAT, 0, BD96811_DIN3_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_TW_ERR_STAT, 0, BD96811_TW_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_AD1_ERR_STAT, 0, BD96811_AD1_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_AD2_ERR_STAT, 0, BD96811_AD2_ERR_MASK),

	REGMAP_IRQ_REG(BD96811_VREF_ERR_STAT, 1, BD96811_VREF_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_TSD_ERR_STAT, 1, BD96811_TSD_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_UVLO_VIN_ERR_STAT, 1, BD96811_UVLO_VIN_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_OVLO_ERR_STAT, 1, BD96811_OVLO_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_OSC_ERR_STAT, 1, BD96811_OSC_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_SLEEP_ERR_STAT, 1, BD96811_SLEEP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_UVLO_PVIN1_ERR_STAT, 1, BD96811_UVLO_PVIN1_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_PWR_CTRL_SEQ_ERR_STAT, 1, BD96811_PWR_CTRL_SEQ_ERR_MASK),

	/* Reg 0x55 VOUT1 ERR IRQs */
	REGMAP_IRQ_REG(BD96811_VOUT1_PVIN_ERR_STAT, 2, BD96811_VOUT1_PVIN_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_OVP_ERR_STAT, 2, BD96811_VOUT1_OVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_UVP_ERR_STAT, 2, BD96811_VOUT1_UVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_SHDN_ERR_STAT, 2, BD96811_VOUT1_SHDN_ERR_MASK),

	/* Reg 0x56 VOUT2 ERR IRQs */
	REGMAP_IRQ_REG(BD96811_VOUT2_PVIN_ERR_STAT, 3, BD96811_VOUT2_PVIN_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_OVP_ERR_STAT, 3, BD96811_VOUT2_OVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_UVP_ERR_STAT, 3, BD96811_VOUT2_UVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_SHDN_ERR_STAT, 3, BD96811_VOUT2_SHDN_ERR_MASK),

	/* Reg 0x57 VOUT3 ERR IRQs */
	REGMAP_IRQ_REG(BD96811_VOUT3_PVIN_ERR_STAT, 4, BD96811_VOUT3_PVIN_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_OVP_ERR_STAT, 4, BD96811_VOUT3_OVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_UVP_ERR_STAT, 4, BD96811_VOUT3_UVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_SHDN_ERR_STAT, 4, BD96811_VOUT3_SHDN_ERR_MASK),

	/* Reg 0x58 VOUT4 ERR IRQs */
	REGMAP_IRQ_REG(BD96811_VOUT4_PVIN_ERR_STAT, 5, BD96811_VOUT4_PVIN_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_OVP_ERR_STAT, 5, BD96811_VOUT4_OVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_UVP_ERR_STAT, 5, BD96811_VOUT4_UVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_SHDN_ERR_STAT, 5, BD96811_VOUT4_SHDN_ERR_MASK),

	/* Reg 0x59 LDO5 ERR IRQs */
	REGMAP_IRQ_REG(BD96811_LDO5_UVLO_ERR_STAT, 6, BD96811_LDO5_UVLO_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_LDO5_OVP_ERR_STAT, 6, BD96811_LDO5_OVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_LDO5_UVP_ERR_STAT, 6, BD96811_LDO5_UVP_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_LDO5_SHDN_ERR_STAT, 6, BD96811_LDO5_SHDN_ERR_MASK),

	REGMAP_IRQ_REG(BD96811_TW_STAT, 7, BD96811_TW_MASK),
	REGMAP_IRQ_REG(BD96811_WDT_ERR_STAT, 7, BD96811_WDT_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_I2C_ERR_STAT, 7, BD96811_I2C_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_TERR1_ERR_STAT, 7, BD96811_TERR1_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_TERR2_ERR_STAT, 7, BD96811_TERR2_ERR_MASK),
	REGMAP_IRQ_REG(BD96811_DIN4_ERR_STAT, 7, BD96811_DIN4_ERR_MASK),

	REGMAP_IRQ_REG(BD96811_VOUT1_HOCL_STAT, 8, BD96811_VOUT1_HOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_LOCL_STAT, 8, BD96811_VOUT1_LOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_NOCL_STAT, 8, BD96811_VOUT1_NOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_OVD_STAT, 8, BD96811_VOUT1_OVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_UVD_STAT, 8, BD96811_VOUT1_UVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT1_TW_CH_STAT, 8, BD96811_VOUT1_TW_CH_MASK),

	REGMAP_IRQ_REG(BD96811_VOUT2_HOCL_STAT, 9, BD96811_VOUT2_HOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_LOCL_STAT, 9, BD96811_VOUT2_LOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_NOCL_STAT, 9, BD96811_VOUT2_NOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_OVD_STAT, 9, BD96811_VOUT2_OVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_UVD_STAT, 9, BD96811_VOUT2_UVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT2_TW_CH_STAT, 9, BD96811_VOUT2_TW_CH_MASK),

	REGMAP_IRQ_REG(BD96811_VOUT3_HOCL_STAT, 10, BD96811_VOUT3_HOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_LOCL_STAT, 10, BD96811_VOUT3_LOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_NOCL_STAT, 10, BD96811_VOUT3_NOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_OVD_STAT, 10, BD96811_VOUT3_OVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_UVD_STAT, 10, BD96811_VOUT3_UVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT3_TW_CH_STAT, 10, BD96811_VOUT3_TW_CH_MASK),

	REGMAP_IRQ_REG(BD96811_VOUT4_HOCL_STAT, 11, BD96811_VOUT4_HOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_LOCL_STAT, 11, BD96811_VOUT4_LOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_NOCL_STAT, 11, BD96811_VOUT4_NOCL_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_OVD_STAT, 11, BD96811_VOUT4_OVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_UVD_STAT, 11, BD96811_VOUT4_UVD_MASK),
	REGMAP_IRQ_REG(BD96811_VOUT4_TW_CH_STAT, 11, BD96811_VOUT4_TW_CH_MASK),

	REGMAP_IRQ_REG(BD96811_LDO5_OVD_STAT, 12, BD96811_LDO5_OVD_MASK),
	REGMAP_IRQ_REG(BD96811_LDO5_UVD_STAT, 12, BD96811_LDO5_UVD_MASK),
};
...
static const struct regmap_irq_chip bd96811_irq_chip = {
	.name = "bd96811-irq",
	.main_status = BD96811_REG_INT_MAIN,
	.num_main_regs = 1,
	.irqs = &bd96811_irqs[0],
	.num_irqs = ARRAY_SIZE(bd96811_irqs),
	.status_base = BD96811_REG_INT_SYS1,
	.mask_base = BD96811_REG_MASK_INT_SYS1,
	.ack_base = BD96811_REG_INT_SYS1,
	.init_ack_masked = true,
	.num_regs = 13,
	.irq_reg_stride = 1,
	.sub_reg_offsets = &bd96811_sub_irq_offsets[0],
};
...
static struct bd968xx_chip_data bd96811_chip_data = {
	.intb_irqs = bd96811_reg_irqs,
	.intb_irq_chip = &bd96811_irq_chip,
	...
	/* The BD96811 may have IRQ pin depending on OTP */
	.optional_intb = true,
};
...
static int bd96801_i2c_probe(struct i2c_client *i2c)
{
	...
	if (intb_irq < 0 && !cd->optional_intb)

...
// ROHM BD2657SWV regulator driver
...
static const struct linear_range bd2657_buck_volts[] = {
 ...
 */
static const struct linear_range bd2657_buck3_volts_2[] = {
...
static int bd2656_set_voltage_sel(struct regulator_dev *rdev, unsigned sel)
{
	int ret = 0;
	struct bd2657_data *d;
...
static const struct bd2657_data bd2657_desc_template[] = {
	{
		...
		.desc = {
			...
			.ops = &bd2657_buck_ops,
			/*
			 * The voltage ranges may be overwritten at probe as they
			 * differ depending on I2C slave address pin connection.
			 */
			.linear_ranges = bd2657_buck_volts,
			.n_linear_ranges = ARRAY_SIZE(bd2657_buck_volts),
